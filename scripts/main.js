...
// --------------------------- OPDRACHT 3 (uitgecomment, want dit was een tussenstap) -------------------------------
// // --- 3A ---
...
// --- 5A ---
// Hiermee vullen we de text-property van het h2-element met id 'role-title'
// document.getElementById('role-title').textContent = 'Marieke';
// Hiermee vullen we de text-property van het p-element met id 'department-description'
// document.getElementById('department-description').textContent = 'Spruitjes...'

// --- 5B ---
// 1. document-statements toegevoegd in beide switch-statements
// 2. Onderstaande statement toegevoegd aan de default-cases in beide switch-statements
// document.getElementById('error-message').textContent = 'Ongeldige keuze. Probeer het opnieuw door de pagina te verversen.';

// --- 5C ---
// Verwerkt in gehele opdracht